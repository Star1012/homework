...
def create_table(table_name):
    try:
        ...
        # 判断表是否存在
        table_live = ""
        create_table_sql = "create table IF NOT EXISTS " + table_name + "( id int auto_increment primary key comment '出租房主键自增'," \
                                                                        "name varchar(100) comment '出租房消息'," \
                                                                        "url varchar(100) comment '出租房链接地址'," \
