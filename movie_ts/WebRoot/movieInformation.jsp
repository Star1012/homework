...
<%
	...
	if (movieId != null){
		...
		ActivityTO activityTO = aDao.getMovieRating(userId, Integer.parseInt(movieId));
		...
		aDAO.insertCustomerActivity(activityTO2);
  		...
  		List<GenreTO> genreTO = movieDao.getGneresById(Integer.parseInt(movieId));
  		String genres = "";
  		...
  		String writer = "";
  		String shortActors = "";
  		List<CrewTO> crews = movieDao.getCrewsById(Integer.parseInt(movieId));
  		List<CastTO> actors = movieDao.getCastsById(Integer.parseInt(movieId));
  		if (actors != null){
